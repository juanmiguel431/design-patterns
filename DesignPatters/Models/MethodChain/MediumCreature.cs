...
public abstract class MediumCreature
{
    private readonly SimpleGame _game;

    public int Attack => _game.CalcAttack(this);

    public int Defense => _game.CalcDefense(this);

    public MediumCreature(SimpleGame game)
    {
        _game = game;
    }
}
